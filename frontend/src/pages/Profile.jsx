  ...
  return (
    <section className="mx-auto max-w-5xl px-4 py-10">
      ...
      <form className="card mt-8 grid gap-5 md:grid-cols-[0.7fr_1.3fr]" onSubmit={handleSubmit(onSubmit)}>
        <div>
          <img className="h-40 w-40 rounded-[2rem] object-cover" src={user.avatarUrl || `https://api.dicebear.com/9.x/initials/svg?seed=${user.name}`} alt={user.name} />
          ...
          <p className="mt-4 rounded-3xl bg-blue-50 p-4 text-sm text-blue-700 dark:bg-blue-500/15 dark:text-blue-200">Complete profiles get better graph recommendations.</p>
        </div>
